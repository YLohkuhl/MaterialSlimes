...
internal class largoIds
{
    ...
    // wood
    public static readonly Identifiable.Id WOOD_METAL_LARGO;
    ...
    public static readonly Identifiable.Id WOOD_SOIL_LARGO;
    ...
    public static readonly Identifiable.Id CONCRETE_GRASS_LARGO;
    ...
    public static readonly Identifiable.Id ICE_GLUE_LARGO;

    public static readonly Identifiable.Id ICE_SOIL_LARGO;

    public static readonly Identifiable.Id ICE_GRASS_LARGO;

    // soil

    public static readonly Identifiable.Id SOIL_GLUE_LARGO;

    // grass

    public static readonly Identifiable.Id GRASS_GLUE_LARGO;
