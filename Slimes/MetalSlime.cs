...
namespace MetalSlime
{
    class MetalSlime
    {
        ...
        public static (SlimeDefinition, GameObject) CreateSlime(Identifiable.Id SlimeId, String SlimeName)
        {
            ...
            slimeAppearance.Icon = CreateSprite(LoadImage("Assets.metal_slime.png"));
            ...
            PediaRegistry.RegisterIdEntry(ModdedIds.metalIds.METAL_ENTRY, CreateSprite(LoadImage("Assets.metal_slime.png")));
