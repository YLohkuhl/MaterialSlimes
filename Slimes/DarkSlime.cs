...
namespace DarkSlime
{
    class DarkSlime
    {
        ...
        public static (SlimeDefinition, GameObject) CreateSlime(Identifiable.Id SlimeId, String SlimeName)
        {
            ...
            slimeDefinition.Diet.AdditionalFoods = new Identifiable.Id[12]
            {
            ...
            slimeAppearance.Icon = CreateSprite(LoadImage("Assets.dark_slime.png"));
            ...
            PediaRegistry.RegisterIdEntry(ModdedIds.darkIds.DARK_ENTRY, CreateSprite(LoadImage("Assets.dark_slime.png")));
