...
namespace CopperSlime
{
    class CopperSlime
    {
        ...
        public static (SlimeDefinition, GameObject) CreateSlime(Identifiable.Id SlimeId, String SlimeName)
        {
            ...
            slimeAppearance.Icon = CreateSprite(LoadImage("Assets.copper_slime.png"));
            ...
            PediaRegistry.RegisterIdEntry(ModdedIds.copperIds.COPPER_ENTRY, CreateSprite(LoadImage("Assets.copper_slime.png")));
