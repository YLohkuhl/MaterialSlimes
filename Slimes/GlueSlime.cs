...
namespace GlueSlime
{
    class GlueSlime
    {
        ...
        public static (SlimeDefinition, GameObject) CreateSlime(Identifiable.Id SlimeId, String SlimeName)
        {
            ...
            slimeAppearance.Icon = CreateSprite(LoadImage("Assets.glue_slime.png"));
            ...
            PediaRegistry.RegisterIdEntry(ModdedIds.glueIds.GLUE_ENTRY, CreateSprite(LoadImage("Assets.glue_slime.png")));
