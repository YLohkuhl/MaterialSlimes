...
namespace ConcreteSlime
{
    class ConcreteSlime
    {
        ...
        public static (SlimeDefinition, GameObject) CreateSlime(Identifiable.Id SlimeId, String SlimeName)
        {
            ...
            slimeAppearance.Icon = CreateSprite(LoadImage("Assets.concrete_slime.png"));
            ...
            PediaRegistry.RegisterIdEntry(ModdedIds.concreteIds.CONCRETE_ENTRY, CreateSprite(LoadImage("Assets.concrete_slime.png")));
