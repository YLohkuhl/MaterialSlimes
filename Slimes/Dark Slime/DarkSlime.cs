...
class DarkSlime
{
    ...
    public static (SlimeDefinition, GameObject) CreateSlime(Identifiable.Id SlimeId, String SlimeName)
    {
        ...
        slimeDefinition.Diet.AdditionalFoods = new Identifiable.Id[19]
        {
        ...
        slimeDefinition.Name = "Dark Slime";
        slimeDefinition.IdentifiableId = ModdedIds.darkIds.DARK_SLIME;
        // OBJECT
        ...
        slimeObject.GetComponent<Identifiable>().id = ModdedIds.darkIds.DARK_SLIME;
        ...
        foreach (SlimeAppearanceStructure slimeAppearanceStructure in structures)
        {
            ...
            if (defaultMaterials != null && defaultMaterials.Length != 0)
            {
                ...
                material2.SetColor("_EdgeColor", new Color32(255, 255, 255, 255));
        ...
        slimeAppearance.Icon = CreateSprite(LoadImage("Assets.Slimes.Dark.dark_slime.png"));
        ...
        PediaRegistry.RegisterIdEntry(ModdedIds.darkIds.DARK_ENTRY, CreateSprite(LoadImage("Assets.Slimes.Dark.dark_slime.png")));
