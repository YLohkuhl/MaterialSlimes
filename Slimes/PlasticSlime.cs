...
namespace PlasticSlime
{
    class PlasticSlime
    {
        ...
        public static (SlimeDefinition, GameObject) CreateSlime(Identifiable.Id SlimeId, String SlimeName)
        {
            ...
            slimeAppearance.Icon = CreateSprite(LoadImage("Assets.plastic_slime.png"));
            ...
            PediaRegistry.RegisterIdEntry(ModdedIds.plasticIds.PLASTIC_ENTRY, CreateSprite(LoadImage("Assets.plastic_slime.png")));
