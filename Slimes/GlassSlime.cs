...
namespace GlassSlime
{
    class GlassSlime
    {
        ...
        public static (SlimeDefinition, GameObject) CreateSlime(Identifiable.Id SlimeId, String SlimeName)
        {
            ...
            slimeAppearance.Icon = CreateSprite(LoadImage("Assets.glass_slime.png"));
            ...
            PediaRegistry.RegisterIdEntry(ModdedIds.glassIds.GLASS_ENTRY, CreateSprite(LoadImage("Assets.glass_slime.png")));
